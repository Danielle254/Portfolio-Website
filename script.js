...
(function appendCertificates() {
  ...
  certificates.forEach((certificate) => {
    stringOutput += `<p class="certificate" id=${certificate.id}>${certificate.inner_html}</p>
        <img src=${certificate.src} id=${certificate.img_id} alt=${certificate.alt}>`;
  });
  certContainer.innerHTML = stringOutput;
})();

const pythonCertificate = document.getElementById("python_cert");
const intermediatePythonCertificate = document.getElementById(
  "intermediate_python_cert"
);
const htmlCertificate = document.getElementById("html_cert");
const cssCertificate = document.getElementById("css_cert");
const intermediateCSSCertificate = document.getElementById(
  "intermediate_css_cert"
);
